...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=RNNoise Demo Installer\n"
      else:
        line="OutputBaseFilename=RNNoise Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the RNNoise Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the RNNoise installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=RNNoise Demo installer\n"
     else:
       line="SetupWindowTitle=RNNoise installer\n"
