...
def main():
  ...
  plistpath = scriptpath + "/resources/RNNoise-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/RNNoise-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/RNNoise-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/RNNoise-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/RNNoise-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/RNNoise.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/RNNoise.iss",inplace=1):
